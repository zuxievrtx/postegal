                        ...
                        <div class="news-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/news2.jpg') }}" alt="" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/newss2.jpg') }}" alt="" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/newsss2.jpg') }}" alt="" />
                                </div>
                            </div>
                        ...
                        <div class="news-info">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a
                                        href="
                  https://mediaindonesia.com/jabar/berita/674356/pos-indonesia-luncurkan-program-ramah-lingkungan-posind-goes-">bit.ly/POSINDGOGREEN</a>
                                </li>
                            </ul>
                        </div>
