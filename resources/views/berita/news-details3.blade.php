                        ...
                        <div class="news-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/news3.jpg') }}" alt="" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/newss3.jpg') }}" alt="" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/newsss3.jpg') }}" alt="" />
                                </div>
                            </div>
                        ...
                        <div class="news-info">
                            ...
                            <ul>
                                ...
                                <li>
                                    <strong>URL</strong>:
                                    <a
                                        href="https://visi.news/pt-pos-indonesia-gandeng-shopee-luncurkan-pusat-edukasi-dan-literasi-digital-posaja-umkm-umkm-centre/">bit.ly/POSINDSHOP</a>
                                </li>
                            </ul>
                        </div>
