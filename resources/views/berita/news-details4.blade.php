                        ...
                        <div class="news-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/news4.jpg') }}" alt="" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/newss4.jpg') }}" alt="" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/newsss4.jpg') }}" alt="" />
                                </div>
                            </div>
                        ...
                        <div class="news-info">
                            ...
                            <ul>
                                ...
                                <li>
                                    <strong>URL</strong>:
                                    <a
                                        href="https://www.rri.co.id/bisnis/833809/dorong-umkm-naik-kelas-melalui-posaja-umkm-fest-2024">bit.ly/POSINDUMKM</a>
                                </li>
                            </ul>
                        </div>
