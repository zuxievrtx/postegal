                        ...
                        <div class="news-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/news7.jpg"') }} alt="" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/newss7.jpg') }}" alt="" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{ asset('assets/img/newsss7.jp') }}g" alt="" />
                                </div>
                            </div>
                        ...
                        <div class="news-info">
                            ...
                            <ul>
                                ...
                                <li>
                                    <strong>URL</strong> :
                                    <a
                                        href="https://rejabar.republika.co.id/berita/sgwwfa512/perkuat-umkm-di-bumn-erick-thohir-resmikan-vending-machine-binaan-posind-bandung">bit.ly/POSINDBANDUNG</a>
                                </li>
                            </ul>
                        </div>
